...
const long int POSITION_TOLERANCE = 100; //Removing this for the time being
const float QP_AT_FULL_STROKE = 650; //Quadrature pulses at 100% TV that occurs from zeropoint
const float MOTOR_RETURN_FACTOR = 0.35; // Percent of nominal exalation time used to return the motor to zeropoint
...
const float INERTIA_BUFFER = 0.3; //Seconds; The motor has inertia, we allow extra time for it too start and stop
