...
const long int QP_TO_ZEROPOINT = 550; //Quadrature pulses from limit switch to bag edge
...
const float MOTOR_RETURN_FACTOR = 0.1; // Percent of nominal exalation time used to return the motor to zeropoint
