...
const int HIGH_PIP_ALARM_SELECT_PIN = 22;
const int LOW_PIP_ALARM_SELECT_PIN = 24;
const int HIGH_PEEP_ALARM_SELECT_PIN = 26;
const int LOW_PEEP_ALARM_SELECT_PIN = 28;
