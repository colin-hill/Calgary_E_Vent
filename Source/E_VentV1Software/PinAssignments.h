...
const int ALARM_BACKLIGHT		= 31;
const int VENT_BACKLIGHT		= 33;
...
// Alarm pins
const int ALARM_BUZZER_PIN = 23;
const int ALARM_LED_PIN    = 12;//Originally 40
...
const int HIGH_RESPIRATORY_RATE_ALARM_SELECT_PIN = 35; //TODO: Make sure this pin is correct
...
const int VC_MODE_LED_PIN  = 34; //Originally 7
const int AC_MODE_LED_PIN  = 36; //Originally 9
